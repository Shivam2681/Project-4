...
const OnlineVardan = () => {
  return (
    <div className="w-full flex flex-col md:flex-row items-center justify-center px-4 py-8 md:py-12">
      {/* Left side - Image */}
      ...
      {/* Right side - Content */}
      <div className="w-full  flex flex-col md:w-3/4 items-center md:items-start mt-8 md:mt-0 md:pl-8">
        {/* Heading Group */}
