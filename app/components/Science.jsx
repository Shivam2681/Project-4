...
import { Quote, Flame, Atom, ArrowRight } from "lucide-react";
    ...
    <>
      ...
      <div className="p-4 md:p-8 bg-yellow-200 md:px-20">
        ...
        <div className="text-center mb-4">
          <div className="flex flex-col md:flex-row justify-center items-center mb-0">
            <img
              src="/Agni2.png"
        ...
        <div className="flex flex-col md:flex-row justify-center items-start">
          <div className="w-full md:w-1/2 p-4 md:p-10 md:pt-16">
